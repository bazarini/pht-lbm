...
export default function RegisterPage() {
  ...
  async function handleSubmit(e) {
    ...
    if (result.error) {
      ...
      setSuccess('Письмо отправлено! Проверьте почту и перейдите по ссылке для подтверждения.')
    } else {
      navigate('/')
    }
  }
      ...
      <div className={styles.card}>
        ...
        {success ? (
          ...
          <>
            ...
            <button className={styles.btnGoogle} onClick={handleGoogle} disabled={busy}>
              <GoogleIcon />
